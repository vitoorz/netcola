...
func (t *martiniType) Start(bus *dm.DataMsgPipe) bool {
	t.Output = bus
	return true
}

func (t *martiniType) Pause() bool {
	return true
}

func (t *martiniType) Resume() bool {
	return true
}

func (t *martiniType) Exit() bool {
	return true
}

func (t *martiniType) ControlHandler(msg *cm.ControlMsg) (int, int) {
	//switch msg.MsgType {
